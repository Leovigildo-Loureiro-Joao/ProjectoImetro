...
import com.imetro.services.GroqService;
...
public record GeracaoSimuladoRequest(
    ...
    public GeracaoSimuladoRequest {
        ...
        quantidadeQuestoes = quantidadeQuestoes <= 0 ? GroqService.DEFAULT_SIMULADO_QUESTOES : quantidadeQuestoes;
    ...
    public static GeracaoSimuladoRequest padrao() {
        return new GeracaoSimuladoRequest("GERAL", "pt-AO", GroqService.DEFAULT_SIMULADO_QUESTOES, "MISTO", "");
    }
}

...
public class TesteMatematicaService {
    ...
    public List<Questao> carregarQuestoes() {
        ...
        q3.setOpcaoF("⚠️ Confundo área com circunferência");
        ...
        q6.setOpcaoF("⚠️ Confundo soma com produto");
        q6.setOpcaoG("⏭️ Muito difícil, vou pular");
        ...
        q7.setOpcaoC("500 km");
        q7.setOpcaoD("0,5 km");
        q7.setOpcaoE("🗺️ Sei mas erro na conversão");
        ...
        q10.setOpcaoF("⚠️ Confundo proporção direta com inversa");
        q10.setOpcaoG("⏭️ Muito confuso");
